...
* `archiver -d archive_name folder_name` - разархивировать файлы из архива `archive_name` и положить в директорию `folder_name`. Имена файлов должны сохраняются при архивации и разархивации.
